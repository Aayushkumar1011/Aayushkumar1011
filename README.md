...
<br/>
 ...
 <h4 align="left">Languages and Frameworks Stats:</h4>
  
  <p align="left"> <a href='https://profile.codersrank.io/user/Aayushkumar1011/'>
  <img src='http://cr-skills-chart-widget.azurewebsites.net/api/api?username=Aayushkumar1011&padding=30&skills=angular,batchfile,c,C%23,coffeescript,dart,go,html,json,java,javascript,less,mysql,php,pandas,perl,python,reactjs,scss,shell,svelte,swift,typescript,vue'>
  </a> </p>
